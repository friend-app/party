  ...
  render() {
    let routes = (
      <Switch>
        ...
        <Route
          exact
          path='/events/userChoice'
          component={ChoicesTabComponent}
        />
        <Route
          exact
          path='/events/eventForUser/userChoices/foodUserChoice'
          component={FoodUserChoice}
        />
        <Route
          exact
          path='/events/eventForUser/userChoices/drinkUserChoice'
