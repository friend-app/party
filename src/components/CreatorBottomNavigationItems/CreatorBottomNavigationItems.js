...
const CreatorBottomNavigationItems = props => {
  return (
    ...
    <CreatorBottomNavigationItem link='/events/eventForCreator/allChoices' isExact={true}>
    <img src={summaryImg} alt="icon"></img><span>Summary</span>
    </CreatorBottomNavigationItem>
  </nav>
  );
};
